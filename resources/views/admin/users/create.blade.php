              ...
              @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('contact1') is-invalid @enderror" placeholder="Contact Number" name="contact1" value="{{ old('contact1') }}" required autocomplete="contact1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group row mt-3" id="rider">
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('license') is-invalid @enderror" placeholder="License" name="license" value="{{ old('license') }}" autocomplete="license">
